...
export const knowledgeDigestAction: Action = createActionTemplate({
  ...
  description:
    "Generate comprehensive knowledge digest summarizing recent research insights, predictions, and performance metrics from curated sources",
  similes: [
    "RESEARCH_DIGEST",
    "DAILY_DIGEST",
    "KNOWLEDGE_SUMMARY",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is requesting a knowledge digest. I need to synthesize recent research insights, track prediction accuracy, and provide a comprehensive intelligence summary covering market developments, institutional adoption trends, and performance metrics from our research sources.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User wants today's research summary. I should provide a focused digest of the most recent insights, highlighting key themes, prediction updates, and validation of our analytical models from the research channels.",
          actions: ["KNOWLEDGE_DIGEST"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is asking about recent learnings. I need to synthesize the most important insights from our research sources, focusing on institutional flows, market positioning, and correlation analysis to provide actionable intelligence.",
          actions: ["KNOWLEDGE_DIGEST"],
        },
      },
    ],
  ...
  handlerFn: async (
    ...
    const thoughtProcess =
      "User is requesting a knowledge digest. I need to synthesize recent research insights, track prediction accuracy, analyze performance metrics, and provide comprehensive intelligence from our curated sources including research channels, market data, and institutional signals.";
    ...
    try {
      ...
      const response = ResponseCreators.createStandardResponse(
        ...
        "KNOWLEDGE_DIGEST",
        {
          ...
          performance:
            digestIntelligence.content.knowledgeDigest.performanceReport,
        },
      );
      ...
      let errorMessage =
        "Knowledge synthesis systems operational. Research monitoring continues. Intelligence processing may be delayed.";
      ...
      if (
        ...
        errorMessage =
          "Research data rate limited. Knowledge synthesis paused temporarily. Intelligence gathering continues at reduced frequency.";
      } else if (
        ...
        errorMessage =
          "Research source connectivity issues. Knowledge synthesis temporarily impaired. Local intelligence cache operational.";
      } else if (
        errorMsg.includes("service") ||
        errorMsg.includes("unavailable")
      ) {
        errorMessage =
          "Knowledge processing service temporarily down. Research monitoring continues. Intelligence backlog being processed.";
      }
