...
export const altcoinPriceAction: Action = {
  ...
  handler: async (
    ...
    try {
      ...
      const errorResponse = {
        thought:
          "Failed to get altcoin price data, providing fallback information.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User asked about Ethereum price. Retrieved current price: $3,420 with +2.15% 24h change.",
          actions: ["GET_ALTCOIN_PRICE"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User asked about Solana price. Retrieved current price: $198.45 with -1.23% 24h change.",
          actions: ["GET_ALTCOIN_PRICE"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User asked about ETH and SOL prices. Retrieved prices for 2 coins.",
          actions: ["GET_ALTCOIN_PRICE"],
        },
      },
    ],
