...
const formatNFTMarketSummary = (collections: any[], summary: any): string => {
  ...
  const volumeContext =
    summary.totalVolume24h > 500
      ? "High activity"
      : summary.totalVolume24h > 200
        ? "Moderate activity"
        : summary.totalVolume24h > 50
          ? "Low activity"
          : "Minimal activity";
...
const formatTopPerformers = (
  ...
  return topPerformers
    ...
    .map((collection, i) => {
      ...
      const floorText = floorItem
        ? ` (floor: ${floorItem.price_eth.toFixed(3)} ETH)`
        : "";
...
const generateSatoshiNFTAnalysis = (
...
export const curatedNFTsAction: Action = createActionTemplate({
  ...
  description:
    "Comprehensive analysis of curated NFT collections including blue-chip NFTs, generative art, and high-end digital art collections with floor price monitoring",
  similes: [
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User wants current NFT market performance. I should analyze floor prices, volume, and market sentiment across premium collections, then provide perspective on NFTs versus Bitcoin as a store of value.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User asking specifically about CryptoPunks floor price. I need to provide current floor data, context about recent activity, and contrast with Bitcoin's fixed supply.",
          actions: ["CURATED_NFTS_ANALYSIS"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User interested in generative art category performance. I should focus on the key generative art collections, their floor prices and performance, while maintaining perspective on their nature as collectibles rather than sound money.",
          actions: ["CURATED_NFTS_ANALYSIS"],
        },
      },
    ],
  ...
  handlerFn: async (
    ...
    const thoughtProcess =
      "User is requesting NFT market analysis. I need to analyze curated NFT collections including floor prices, volume, and market sentiment, then provide perspective on NFTs as cultural artifacts versus Bitcoin as sound money.";
