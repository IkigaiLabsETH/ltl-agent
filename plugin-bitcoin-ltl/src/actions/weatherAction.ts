...
export const weatherAction: Action = createActionTemplate({
  ...
  description:
    "Comprehensive weather and surf analysis for European lifestyle cities, with detailed Biarritz surf conditions and regional weather intelligence",
  similes: [
    "WEATHER_REPORT",
    "SURF_REPORT",
    "WEATHER_CONDITIONS",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is asking specifically about Biarritz surf conditions. I need to provide detailed surf metrics including wave height, period, water temperature, and assess the conditions for different skill levels while incorporating the philosophical perspective on ocean energy systems.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User wants a comprehensive European weather overview. I should provide temperature, wave conditions, air quality, and UV data for all monitored cities, then synthesize this into actionable insights for lifestyle decisions.",
          actions: ["WEATHER_ANALYSIS"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is asking about outdoor activity suitability. I need to assess air quality, UV levels, wind conditions, and temperatures to provide specific recommendations for different activities.",
          actions: ["WEATHER_ANALYSIS"],
        },
      },
    ],
  ...
  handlerFn: async (
    ...
    let thoughtProcess =
      "User is requesting weather information. I need to analyze current conditions across European lifestyle cities and provide actionable insights for daily decisions.";

    if (messageText.includes("surf") || messageText.includes("wave")) {
      thoughtProcess =
        "User is asking about surf conditions. I need to provide detailed wave analysis including height, period, water temperature, and suitability assessment for different skill levels, particularly for Biarritz.";
    } else if (
      messageText.includes("outdoor") ||
      messageText.includes("activities")
    ) {
      thoughtProcess =
        "User wants to know about outdoor activity suitability. I should assess air quality, UV levels, wind conditions, and temperatures to provide specific recommendations for different activities.";
    }
    ...
    try {
      ...
      const isBiarritzSurfQuery =
        messageText.includes("biarritz") &&
      ...
      let errorMessage =
        "Weather monitoring systems operational. Natural patterns continue regardless of our observation capabilities.";
      ...
      if (
        ...
        errorMessage =
          "Weather data rate limited. Like Bitcoin mining difficulty, natural systems have their own rate limits. Will retry shortly.";
      } else if (
        ...
        errorMessage =
          "Weather service connectivity issues. Natural weather patterns continue independently of our monitoring infrastructure.";
      } else if (errorMsg.includes("api") || errorMsg.includes("service")) {
        errorMessage =
          "Weather API temporarily down. The weather itself remains decentralized and operational - only our monitoring is affected.";
      }
 ...
 */
function assessSurfConditions(marine: any): {
  size: string;
  quality: string;
  suitability: string;
} {
