...
export const bookingOptimizationAction: Action = createActionTemplate({
  ...
  description:
    "Compare and optimize hotel bookings across multiple properties for maximum value, analyzing rates, timing, and seasonal patterns",
  similes: [
    "OPTIMIZE_BOOKING",
    "COMPARE_HOTELS",
    "BEST_VALUE_HOTELS",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User wants hotel optimization analysis for Monaco. I need to compare available properties, assess value propositions, analyze seasonal pricing, and provide strategic recommendations while maintaining Bitcoin-enabled travel philosophy.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User seeking luxury booking optimization strategy. I need to analyze premium properties, identify optimal booking windows, assess luxury value propositions, and provide strategic guidance for maximizing luxury travel experiences.",
          actions: ["BOOKING_OPTIMIZATION"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User comparing cities for best hotel value. I need to analyze properties across both locations, compare value propositions, assess location benefits, and provide clear recommendation with reasoning.",
          actions: ["BOOKING_OPTIMIZATION"],
        },
      },
    ],
  ...
  handlerFn: async (
    ...
    const thoughtProcess =
      "User is requesting hotel booking optimization. I need to analyze available properties, compare value propositions, assess seasonal pricing, and provide strategic recommendations while maintaining Bitcoin travel philosophy.";
...
function performBookingOptimization(
  ...
  const summary = {
    ...
    averageSavings:
      comparisons.reduce((sum, c) => sum + c.savingsPercentage, 0) /
      comparisons.length,
...
function calculateValueScore(hotel: any, bestDate: any): number {
  ...
  const savingsScore =
    Math.min((bestDate.savingsPercentage || 0) / 100, 1) * 40;
...
function calculateLuxuryScore(hotel: any): number {
  ...
  const luxuryAmenitiesCount = (hotel.amenities || []).filter((a: string) =>
