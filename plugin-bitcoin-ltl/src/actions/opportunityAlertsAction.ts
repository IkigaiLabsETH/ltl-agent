...
export const opportunityAlertsAction: Action = createActionTemplate({
  ...
  description:
    "Monitor and report active market opportunity alerts, investment signals, and actionable insights across crypto, stocks, and alternative assets",
  similes: [
    "ALERTS",
    "OPPORTUNITIES",
    "INVESTMENT_ALERTS",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is requesting current opportunity alerts. I need to check the alert service for active opportunities, categorize them by urgency (immediate, upcoming, watchlist), and present them with confidence levels and actionable insights for informed decision-making.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is asking about immediate opportunities. I should focus on the most actionable alerts, highlighting time-sensitive opportunities and providing context for decision-making while noting the importance of patience in market timing.",
          actions: ["OPPORTUNITY_ALERTS"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User is asking about watchlist items. Currently there are no active alerts, so I should communicate this clearly while reassuring them that monitoring systems are active and maintaining the disciplined approach of waiting for quality signals.",
          actions: ["OPPORTUNITY_ALERTS"],
        },
      },
    ],
  ...
  handlerFn: async (
    ...
    const thoughtProcess =
      "User is requesting opportunity alerts. I need to check the alert service for active market opportunities, categorize them by urgency and type, analyze confidence levels, and provide actionable insights for investment decisions while emphasizing proper risk management.";

    try {
      // Get the alert service
      const alertService = runtime.getService(
        "opportunity-alert",
      ) as unknown as OpportunityAlertService;
      ...
      let errorMessage =
        "Alert systems operational. Manual monitoring continues. Market vigilance maintained.";
      ...
      if (
        ...
        errorMessage =
          "Alert data rate limited. Opportunity monitoring paused temporarily. Manual vigilance advised for immediate signals.";
      } else if (
        ...
        errorMessage =
          "Alert service connectivity issues. Local monitoring systems active. Continue manual market observation.";
      } else if (
        errorMsg.includes("service") ||
        errorMsg.includes("unavailable")
      ) {
        errorMessage =
          "Alert processing service temporarily down. Opportunity monitoring continues via backup systems. Stay alert for signals.";
      }
