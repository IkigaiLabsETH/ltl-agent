...
export const etfFlowAction: Action = createActionTemplate({
  ...
  description:
    "Comprehensive Bitcoin ETF flow tracking including inflows, outflows, holdings, premiums, and institutional adoption metrics across all major Bitcoin ETFs",
  similes: [
    "BITCOIN_ETF_FLOWS",
    "ETF_FLOWS",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User wants current Bitcoin ETF flow data. I need to analyze institutional flows, supply dynamics, and assess the impact on Bitcoin supply-demand balance.",
    ...
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User asking about ETF Bitcoin holdings. I should provide total holdings, percentage of supply, and context about the structural impact on Bitcoin scarcity.",
          actions: ["ETF_FLOW_TRACKING"],
        },
      },
    ],
    [
      ...
      },
      {
        ...
        content: {
          ...
          thought:
            "User wants to know about current ETF buying activity. I need to analyze recent flows, identify which ETFs are seeing inflows vs outflows, and contextualize versus Bitcoin mining supply.",
          actions: ["ETF_FLOW_TRACKING"],
        },
      },
    ],
  ...
  handlerFn: async (
    ...
    const thoughtProcess =
      "User is requesting Bitcoin ETF flow analysis. I need to analyze institutional flows, Bitcoin holdings, supply dynamics, and assess the impact on Bitcoin scarcity and adoption.";
...
function formatETFReport(data: ETFMarketData): string {
  ...
  const largestETFsText = largestETFs
    .map(
      (etf) =>
