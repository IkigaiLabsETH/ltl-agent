...
export const marketContextProvider: Provider = {
  ...
  get: async (runtime: IAgentRuntime, message: Memory, state: State) => {
    try {
      ...
      const currentPrice =
        state?.values?.bitcoinPrice || (await bitcoinService.getBitcoinPrice());
      ...
      const institutionalTrends =
        await bitcoinService.analyzeInstitutionalTrends();
      ...
      return {
        ...
        values: {
          ...
          growthCategory:
            thesisMetrics.requiredCAGR.fiveYear < 25
              ? "conservative"
              : thesisMetrics.requiredCAGR.fiveYear < 50
                ? "moderate"
                : "aggressive",
          ...
          adoptionCategory:
            adoptionScore > 70
              ...
              : adoptionScore > 40
                ? "moderate"
                : "early",
          corporateAdoptionCount:
            institutionalTrends.corporateAdoption?.length || 0,
          bankingIntegrationCount:
            institutionalTrends.bankingIntegration?.length || 0,
          sovereignActivityCount:
            institutionalTrends.sovereignActivity?.length || 0,
