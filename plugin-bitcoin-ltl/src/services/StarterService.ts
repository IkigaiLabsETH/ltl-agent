...
import { LoggerWithContext, generateCorrelationId } from '../utils/loggingUtils';
    ...
    try {
      ...
      return {
        ...
        message: `Memory reset failed: ${enhancedError.message}${
          enhancedError instanceof Error && 'resolution' in enhancedError ? ` Resolution: ${(enhancedError as any).resolution}` : ''
        }`
      };
    }
  }
