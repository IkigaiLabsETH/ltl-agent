...
describe("NewsDataService", () => {
  ...
  describe("News Fetching", () => {
    ...
    it("should fetch category news correctly", async () => {
      ...
      const result = await (service as any).fetchCategoryNews(
        category,
        "test-key",
      );
  ...
  describe("Relevance Scoring", () => {
    it("should calculate relevance score correctly", () => {
      ...
      const result = (service as any).calculateRelevanceScore(
        title,
        description,
        category,
      );
    ...
    it("should calculate news summary correctly", () => {
      const newsItems = [
        ...
        },
        {
          ...
          source: "TechNews",
          keywords: ["crash", "bearish"],
        },
        {
          sentiment: "neutral" as const,
          source: "FinanceNews",
          keywords: ["analysis", "market"],
        },
      ];
